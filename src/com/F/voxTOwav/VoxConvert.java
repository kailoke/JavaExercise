...
public class VoxConvert {
    ...
    public static void main(String argus[]) throws Exception {
        String path_src = "G:\\vox\\src\\";
        String path_dest = "G:\\vox\\dest\\";
...
//                System.out.println("文     件：" + tempList[i]);
        ...
        for (int i = 0; i<fileNameList.size(); i++)
        {
            ...
            String voxFile = path_src + fileName;
            String out = voxFile.substring(voxFile.indexOf("b"),voxFile.indexOf("."));
            String wavFile = path_dest+ out + ".wav";

//            System.out.println("src:" + voxFile);
